...
public abstract class Conta { // Conta Genérica // Conta Padrão // Conta Base
  ...
  // Um método abstrato dizo que será feito
  // mas não como será feito. É um método sem corpo.

  // É obrigatório concretizar na subclasse.
